...
gethConnectBtn.onclick = function () { return __awaiter(_this, void 0, void 0, function () {
    var con, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, web3.eth.net.isListening()];
            case 1:
                con = _a.sent();
...
accountsBtn.onclick = function () { return __awaiter(_this, void 0, void 0, function () {
    var accounts, accountsObjArray, _a, _b, _i, i, balance, _c, _d, accountsObj;
